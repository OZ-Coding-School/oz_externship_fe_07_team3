  ...
  return (
    <div
      className={cn(
        ...
        isOpen && '[#121212] border-[#707070] bg-[#FAFAFA]',
        className
      )}
    >
...
const itemHoverColor =
  'data-[highlighted]:bg-[#EFE6FC] data-[highlighted]:text-black w-full h-12'
